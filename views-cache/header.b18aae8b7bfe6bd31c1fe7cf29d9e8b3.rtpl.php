...
<head>
  ...
  <title>AdminLTE 2 | E-commerce Store</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="/adm/index2.html" class="logo">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/categories"><i class="fa fa-warning"></i> <span>Categorias</span></a></li>
        <li><a href="/admin/products"><i class="fa fa-product"></i> <span>Produtos</span></a></li>
        <li class="treeview">
