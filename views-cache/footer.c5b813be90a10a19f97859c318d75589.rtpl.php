<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="footer-top-area">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        ...
                        <div class="footer-social">
                            ...
                            <a href="https://www.linkedin.com/in/lucas-ramos-461b6b149/" target="_blank"><i class="fa fa-linkedin"></i></a>
    ...
    <!-- Slider -->
    <script type="text/javascript" src="/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/site/js/script.slider.js"></script>
  </body>
</html>
	</body>
</html>