            ...
            <div class="col-md-6">
                <?php if( $Error_Login != ''  ){ ?>
                 ...
                 <div class="alert alert-danger">
                    <?php echo htmlspecialchars( $Error_Login, ENT_COMPAT, 'UTF-8', FALSE ); ?>
            ...
            <div class="col-md-6">
                ...
                <form id="register-form-wrap" action="/register" class="register" method="post">
                    ...
                    <p class="form-row form-row-first">
                        ...
                        <input type="text" id="nome" name="name" class="input-text" value="<?php echo htmlspecialchars( $ValuesRegister["name"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </p>
                    <p class="form-row form-row-first">
                        <label for="email">E-mail <span class="required">*</span>
                        </label>
                        <input type="email" id="email" name="email" class="input-text" value="<?php echo htmlspecialchars( $ValuesRegister["email"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </p>
                    <p class="form-row form-row-first">
                        <label for="phone">Telefone
                        </label>
                        <input type="text" id="phone" name="phone" class="input-text" value="<?php echo htmlspecialchars( $ValuesRegister["phone"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </p>
                    <p class="form-row form-row-last">
                        <label for="senha">Senha <span class="required">*</span>
                        </label>
