            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Validação de Email</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Para validar seu email acesse o link <a href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?></a>.
                            </td>
                          </tr>
                        </table>
                        <div><!--[if mso]>
