...
class Mailer{
	...
	public function __construct($toAddress, $toName,$subject, $tplName, $data = array())
	{
		...
		$this->mail->Username = MailerValidacao::USEREMAIL;//EMAIL DE ENVIO 

		//Password to use for SMTP authentication
		$this->mail->Password = MailerValidacao::USERPASSWORD;//SENHA DO EMAIL DE ENVIO

		//Set who the message is to be sent from
		$this->mail->setFrom(MailerValidacao::USEREMAIL, MailerValidacao::USERNAME);//QUEM ESTÁ ENVIANDO
